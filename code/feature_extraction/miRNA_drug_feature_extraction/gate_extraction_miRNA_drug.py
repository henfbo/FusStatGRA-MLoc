...
if __name__ == '__main__':
    df_drug = pd.read_csv('../../../feature/miRNA_drug_feature_128_weight.csv', index_col=0)
    df_func = pd.read_csv('../../../dataset/miRNA_func_sim.csv', header=None)
    k1 = 104
    k2 = 13
    # m_fusion_sim, d_fusion_sim = get_fusion_sim(k1, k2)
    # file_path_m = '../../../Fusion/miRNA_fusion_sim_drug_0.15.csv'
    # file_path_d = '../../../Fusion/drug_fusion_sim_0.15.csv'
    # np.savetxt(file_path_m, m_fusion_sim, delimiter=',', )
    # np.savetxt(file_path_d, d_fusion_sim, delimiter=',', )
    m_fusion_sim = pd.read_csv('../../../Fusion/miRNA_fusion_sim_drug_0.14.csv', header=None)
    d_fusion_sim = pd.read_csv('../../../Fusion/drug_fusion_sim_0.14.csv', header=None)

...
def sim_thresholding(matrix: np.ndarray, threshold):#二值化处理
...
if __name__ == '__main__':
    df_mRNA = pd.read_csv('../../../feature/miRNA_mRNA_network_feature_128_weight.csv', index_col=0)
    df_func = pd.read_csv('../../../dataset/miRNA_func_sim.csv', header=None)
    k1 = 104
    k2 = 283
    # m_fusion_sim, d_fusion_sim = get_fusion_sim(k1, k2)
    # file_path_m = '../../../Fusion/miRNA_fusion_sim_mRNA_0.15.csv'
    # file_path_d = '../../../Fusion/mRNA_fusion_sim_0.15.csv'
    # np.savetxt(file_path_m, m_fusion_sim, delimiter=',', )
    # np.savetxt(file_path_d, d_fusion_sim, delimiter=',', )
    m_fusion_sim = pd.read_csv('../../../Fusion/miRNA_fusion_sim_mRNA_0.14.csv', header=None)
    d_fusion_sim = pd.read_csv('../../../Fusion/mRNA_fusion_sim_0.14.csv', header=None)
